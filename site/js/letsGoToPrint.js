    ...
    if(countClick==1){
        ...
        document.querySelector('body > main:nth-child(1) > article:nth-child(1) > strong:nth-child(16)').style.display="none";
        document.querySelector('body > main:nth-child(1) > article:nth-child(1) > strong:nth-child(17)').style.display="none";
    ...
    document.querySelector('body > main:nth-child(1) > article:nth-child(1) > strong:nth-child(16)').style.display="";
    document.querySelector('body > main:nth-child(1) > article:nth-child(1) > strong:nth-child(17)').style.display="";

    document.querySelector('#invoicing > footer:nth-child(9)').style.display="";
